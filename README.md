...
1. From the first stage, we can see that I have used Google drive as my uploading tool, it requires you to have a client id and client secret which can be found in <a href=“https://www.cloud.google.com">**Google cloud**</a>
